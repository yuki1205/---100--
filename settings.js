...
window.RUNAWAY_SETTINGS = {
  ...
  difficulties: {
    easy: { label: 'EASY', initialChaserCount: 1, graceSeconds: 30, speedKmh: 8 },
    normal: { label: 'NORMAL', initialChaserCount: 2, graceSeconds: 20, speedKmh: 10, recommended: true },
    hard: { label: 'HARD', initialChaserCount: 3, graceSeconds: 10, speedKmh: 12 },
  },
  goals: {
